...
export default withMermaid({
	...
	head: [
		...
		['meta', { property: 'og:description', content: 'TypeScriptで学ぶSOLID原則' }],
		[
			'meta',
			{
				property: 'og:image',
				content: 'https://shuji-bonji.github.io/Notes-on-SOLID-Principle/images/solid.webp',
			},
		],
		[
			'meta',
		...
		['meta', { name: 'twitter:description', content: 'TypeScriptで学ぶSOLID原則' }],
		[
			'meta',
			{
				name: 'twitter:image',
				content: 'https://shuji-bonji.github.io/Notes-on-SOLID-Principle/images/solid.png',
			},
		],
	...
	themeConfig: {
		nav: [
			...
			{ text: '批判と限界', link: '/solid-criticism.md' },
		...
		sidebar: [
			...
			{
				text: 'ケーススタディ',
				items: [{ text: 'ECサイト機能拡張', link: '/practical-case-studies.md' }],
			},
			{
				text: 'OOPと関数型の比較',
